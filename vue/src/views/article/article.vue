<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" prop="content" label="文章" width="140" style="flex-wrap: wrap;"></el-table-column>
      <el-table-column align="center" prop="file" label="内容" width="400" style="flex-wrap: wrap;"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempArticle" label-position="left" label-width="60px"
        ...
        <el-form-item label="内容">
          <el-input type="textarea" :rows="5" v-model="tempArticle.file"></el-input>
        </el-form-item>
      </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      showCreate() {
        ...
        this.tempArticle.file = "";
      },
      showUpdate($index) {
        //显示修改对话框
        this.tempArticle.id = this.list[$index].id;
        this.tempArticle.content = this.list[$index].content;
        this.tempArticle.file = this.list[$index].file;
